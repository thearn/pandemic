...
states['int_sigma'] = {'name' : 'int_sigma', 'rate_source' : 'sigma_sq', 'defect_scaler' : ds, 
                       'interp_s' : 0.0, 'interp_f' : 1.0, 'c' : 'pink', 'targets' : []}
...
p.driver.opt_settings['tol'] = 1e-9
