...
def test_model_partials():
    ...
    p.model = om.Group()
    n = 35
    from pandemic.models.SEIR import SEIR, states, params, s_params
...
def test_baseline_run():
    from pandemic.models.SEIR import SEIR, states, params, s_params, ns, t_duration_bounds, t_initial_bounds
    # test baseline model
